...
--
-- كان الرصيد والأسعار بالهللات، والآن بالكوينز — والصرف ١ كوينز = ٣
-- هللات (١٠٠٠ كوينز = ٣٠ ر.س، وهي قيمة رصيد آثار+ الشهري نفسها). فكل
...
INSERT INTO "CoinPack" ("id", "name", "coins", "priceHalalas", "sortOrder") VALUES
  ('pack_500',  '٥٠٠ كوينز',   500,  1500, 1),
  ('pack_1000', '١٠٠٠ كوينز', 1000,  3000, 2),
  ('pack_2000', '٢٠٠٠ كوينز', 2000,  6000, 3);
