 ...
 *
 * وكلّها من إصداراتٍ قديمة (يونيكود ١١ فما دون): ما جاء بعدها —
 * 🫶 و🥹 و🫣 و🫂 — يرسمه جهازٌ ولا يرسمه آخر، فيخرج مربّعاً فارغاً.
 * وكانت الأولى منها أوّلَ الصفّ بجانب الفاصل، فمن ضغطها تفاعل بفراغ.
 */
export const CUSTOM = [
  "🤗", "🔥", "🙏", "👏", "🥰", "☕️",
  "❤️", "😍", "🤍", "✨", "🌙", "⭐️",
