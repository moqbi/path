...
say "الاعتماديات"
# pnpm وحده: قفلُه يحمل المشاريع الأربعة ومعها الويب في الجذر
# (المستورِد `.:`). وقفلُ npm حُذف — وجودُهما معاً يجعل EAS يظنّ
# الجوّال عضواً في مساحة npm فينصّب اعتماديات الويب مكان `expo`.
